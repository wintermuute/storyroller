...
module.exports = {
	name: 'removebook',
	description: 'Marks books as unowned using White Wolf\'s publication numbers',
	execute(message, args) {
		...
		else
		{
			...
			message.channel.send(`${titles} ${plural} now marked as unowned.`);
		}
